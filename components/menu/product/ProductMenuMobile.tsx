                    ...
                    {(onClose) => (
                        <>
                            <ModalBody className="p-0">
                                ...
                                <Accordion className="mt-0 h-8 text-base">
                                    <AccordionItem
                                        title="F5 Distributed Cloud Service"
                                        className="border-slate-100 ml-4 border-b-1 font-semibold">
                                        <p key='index' className="border-slate-100 ml-6 border-b-1 h-8">View all F5 Distributed Cloud Service &gt;</p>
                                        {F5_DISTRIBUTED_CLOUD_SERVICE_ITEMS.map((item, index) => (
                                            <p key='index' className="border-slate-100 ml-10 border-b-1 h-8">{item.title} &gt;</p>
                                        ))}
                                    </AccordionItem>
                                    <AccordionItem
                                        title="F5 NGINX"
                                        className="border-slate-100 ml-4 border-b-1 font-semibold">
                                        <p key='index' className="border-slate-100 ml-6 border-b-1 h-8">View all F5 NGINX &gt;</p>
                                    ...
                                    <AccordionItem
                                        title="F5 BIG-IP"
                                        className="border-slate-100 ml-4 border-b-1 font-semibold">
                                        <p key='index' className="border-slate-100 ml-6 border-b-1 h-8">View all F5 BIG-IP &gt;</p>
                                    ...
                                    <AccordionItem
                                        title="F5 systems"
                                        className="border-slate-100 ml-4 border-b-1 font-semibold">
                                        <p key='index' className="border-slate-100 ml-6 border-b-1 h-8">View all F5 systems &gt;</p>
